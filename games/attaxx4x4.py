...
class Attaxx:
    ...
    def board_has_moves(self):
        if self.empty_squares() == 0 or self.player_pieces(1) == 0 or self.player_pieces(-1) == 0: return False
        elif len(self.legal_actions(1)) == 0 or len(self.legal_actions(-1)) == 0: return False
