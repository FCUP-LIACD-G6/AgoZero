...
class MuZeroConfig:
    def __init__(self):
        ...
        self.observation_shape = (3, 4, 4)  # Dimensions of the game observation, must be 3D (channel, height, width). For a 1D array, please reshape it to (1, 1, length of array)
        board_size = 4
