...
class Go:
    ...
    def find_group(self, row, col):
        ...
        while queue:
            ...
            if (r, c) in group:
                continue
            group.add((r, c))
            for dr, dc in [(-1, 0), (1, 0), (0, -1), (0, 1)]:       #verifica as posições adjacentes
                nr, nc = r + dr, c + dc
    ...
    def step(self, action):
        ...
        # Normal move
            ...
            to_remove = []
            for dr, dc in [(-1, 0), (1, 0), (0, -1), (0, 1)]:   # verifica todas as posições adjacentes
                nr, nc = row + dr, col + dc
